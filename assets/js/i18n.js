...
(function () {
  ...
  const EXACT_MAP = {
    ...
    'Hesap': 'Account',
    'Oluştur': 'Create',
    'Sana Uygun': 'Best for You',
    'Planı': 'Plan',
    'Seç': 'Choose',
    'Ders': 'Class',
    'Rezervasyonu': 'Booking',
    'Rehberi': 'Guide',
    'Paneli': 'Panel',
    ...
    'Örnek Egzersizler Galerisi': 'Example Exercises Gallery',
    '1300+ egzersizi keşfet. Kas grubuna, ekipmana ve zorluk seviyesine göre filtrele.': 'Discover 1300+ exercises. Filter by muscle group, equipment, and difficulty level.',
    'Eğitmen adı': 'Instructor name',
    'Geçerli bir tarih/saat seçin.': 'Select a valid date/time.',
    'Kayıt bulunamadı.': 'No records found.',
    'İptal': 'Canceled',
    'Ad ve soyad boş bırakılamaz.': 'First and last name cannot be empty.',
    ...
    'E-posta ve şifre gereklidir.': 'Email and password are required.',
    'Giriş başarılı! Yönlendiriliyorsunuz...': 'Login successful! Redirecting...',
    'Giriş başarısız.': 'Login failed.',
    'Kayıt başarılı! Giriş sayfasına yönlendiriliyorsunuz...': 'Registration successful! Redirecting to login...',
